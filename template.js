...
template += "        <\/div>";
template += "    <\/div>";
template += "    <div class=\"row clearfix\" ng-show=\"isInputFieldsAreValid && entry == 'new entry'\">";
template += "        <div class=\"col-md-12 column\">";
template += "            <div class=\"panel panel-default\">";
template += "                <div class=\"panel-heading\">";
template += "                    <h3 class=\"panel-title\">";
...
template += "                            <label>New Entry Or Re-Entry <b>*<\/b> <\/label>";
...
template += "                    <\/button>";
template += "                    <button type=\"button\" class=\"btn btn btn-default\" ng-csv=\"getArrayForCsv()\" filename=\"encoded.csv\"";
