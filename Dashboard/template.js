...
dashboardTemplate += "                        <\/button>";
dashboardTemplate += "                    <\/div>";
dashboardTemplate += "                    <div class=\"row\">";
dashboardTemplate += "                        <div class=\"col-md-12 col-md-offset-2\">";
dashboardTemplate += "                            <div class=\"checkbox\">";
dashboardTemplate += "                                <label>";
dashboardTemplate += "                                    <input type=\"checkbox\" ng-model=\"settings.DownloadActiveAccounts\"\/> Download Active";
dashboardTemplate += "                                    Accounts?";
dashboardTemplate += "                                <\/label>";
dashboardTemplate += "                            <\/div>";
dashboardTemplate += "                            <div class=\"checkbox\">";
dashboardTemplate += "                                <label>";
dashboardTemplate += "                                    <input type=\"checkbox\" ng-model=\"settings.DownloadReadyForEncashment\"\/> Download";
dashboardTemplate += "                                    Ready for Encashment Accounts?";
dashboardTemplate += "                                <\/label>";
dashboardTemplate += "                            <\/div>";
dashboardTemplate += "                            <div class=\"checkbox\">";
dashboardTemplate += "                                <label>";
dashboardTemplate += "                                    <input type=\"checkbox\" ng-model=\"settings.DownloadEncashmentHistory\"\/> Download";
dashboardTemplate += "                                    Encashment History\/Accounts?";
dashboardTemplate += "                                <\/label>";
dashboardTemplate += "                            <\/div>";
dashboardTemplate += "                            <div class=\"checkbox\">";
dashboardTemplate += "                                <label>";
dashboardTemplate += "                                    <input type=\"checkbox\" ng-model=\"settings.DownloadInActiveAccounts\"\/> Download In";
dashboardTemplate += "                                    Active Accounts?";
dashboardTemplate += "                                <\/label>";
dashboardTemplate += "                            <\/div>";
dashboardTemplate += "                            <div class=\"checkbox\">";
dashboardTemplate += "                                <label>";
dashboardTemplate += "                                    <input type=\"checkbox\" ng-model=\"settings.DownloadWallet\"\/> Download E-Wallet?";
dashboardTemplate += "                                <\/label>";
dashboardTemplate += "                            <\/div>";
dashboardTemplate += "                            <div class=\"checkbox\">";
dashboardTemplate += "                                <label>";
dashboardTemplate += "                                    <input type=\"checkbox\" ng-model=\"settings.DownloadMyEarning\"\/> Download My Earnings?";
dashboardTemplate += "                                <\/label>";
dashboardTemplate += "                            <\/div>";
dashboardTemplate += "                        <\/div>";
dashboardTemplate += "                    <\/div>";
